...
def home_page():
    ...
    # 右侧联系方式
    with col2:
        st.image("images/resumepicture1.jpg", width=150) # 添加照片
...
def education_page():
    ...
    st.image("images/picture2.png", width=200) # 添加港中文图片
    ...
    st.image("images/picture3.png", width=200) # 添加对外经贸图片
...
def experience_page():
    ...
    st.image("images/pictureRED.png", width=150) # 添加小红书图片
    ...
    st.image("images/pictureBMW.png", width=150) # 添加宝马图片
    ...
    st.image("images/picturePWC.png", width=150) # 添加普华永道图片
    ...
    st.image("images/pictureMARS.png", width=150) # 添加玛氏图片
...
def project_page():
    ...
    st.image("images/picturePUPPY.png", width=150) # 添加Puppy Hotel项目图片
    ...
    st.image("images/pictureINNOVATION.png", width=150) # 添加创新创业中心图片
